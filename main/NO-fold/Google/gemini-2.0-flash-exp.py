...
# Configuration
GOOGLE_API_KEY = os.environ.get('GOOGLE_API_KEY')  # or set directly: "your-api-key-here"
if not GOOGLE_API_KEY:
    raise ValueError("Please set GOOGLE_API_KEY environment variable or update the code with your API key")
